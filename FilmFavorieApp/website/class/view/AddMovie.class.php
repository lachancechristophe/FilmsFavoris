...
class Addmovie extends Page 
{
    ...
    protected function checkAddMovieCover()
    {
        ...
        {   
            ...
            {
                header("location: index.php?Cover=WrongType$type");
                exit(); 
            }
            else
            {
                if($size > 1000000)
                {
                    header("location: index.php?Cover=SizeTooBig");
    ...
    protected function checkAddMovieInfo()
    {
        ...
        {   
            ...
            {  
                header("location:index.php?Addmovie=empty");
                exit(); 
            }
            else
            {
    ...
    protected function verifAddMovie()
    {
        ...
        else
        {
            ...
            $upload_folder = 'website/style/img/movie_cover/';
            $file_name = $row['count'];
            $movefile = move_uploaded_file($file_tmp,$upload_folder .$file_name."_movie_cover.png");
            header("location:index.php?Addmovie=Sucsess");
            exit(); 
        }
