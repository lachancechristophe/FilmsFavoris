...
class Page
{
    ...
    public function initHTML($titre, $css)
    {
        ...
        $retStr .= '<link rel="stylesheet" type="text/css" href="website/style/topNav.css">';
        $retStr .= '<link rel="stylesheet" type="text/css" href="website/style/style.css">';
        if (!empty($css)) {
    ...
    public function topNav()
    {
        ...
        $topNav .='<img class="logo" src="website/style/img/logo.png" alt="logo" height="82" width="82">
